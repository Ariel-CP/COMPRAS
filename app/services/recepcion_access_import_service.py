...
def mapear_campos_access_a_staging(fila_access: Dict) -> Dict:
    ...
    mapeo = {
        'id_recepcion_original': fila_access.get('ID') or fila_access.get('IDRecepcion'),
        'proveedor_codigo': fila_access.get('Proveedor_Codigo') or fila_access.get('Código Proveedor'),
        'proveedor_nombre': fila_access.get('Proveedor_Nombre') or fila_access.get('Proveedor'),
        'producto_codigo': fila_access.get('Producto_Codigo') or fila_access.get('Código Producto'),
        'producto_nombre': fila_access.get('Producto_Nombre') or fila_access.get('Producto'),
        'cantidad_solicitada': _convertir_tipo_dato(
            fila_access.get('Cantidad_Solicitada') or fila_access.get('Cant. Solicitada'),
            'DECIMAL'
        ),
        ...
        'estado_inspeccion_original': fila_access.get('Estado_Inspeccion') or fila_access.get('Estado'),
        'calidad_ok': 1 if str(fila_access.get('Calidad_OK', '')).upper() in ['SI', 'TRUE', '1', 'OK'] else 0,
        'codigo_no_conformidad': fila_access.get('Codigo_NC') or fila_access.get('NC'),
        'descripcion_no_conformidad': fila_access.get('Descripcion_NC') or fila_access.get('Descripción NC'),
